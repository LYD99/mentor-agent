...
import { MessageSquare, GraduationCap, Map, Bot, Sparkles, Settings, FileText } from 'lucide-react'
            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  <div
                    className={`mb-6 inline-flex h-16 w-16 items-center justify-center rounded-2xl ${module.iconBg} transition-transform duration-300 group-hover:scale-110`}
                  >
